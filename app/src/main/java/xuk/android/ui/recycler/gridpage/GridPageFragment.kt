...
import xuk.android.databinding.FragmentGirdPageBinding
import java.util.*
...
class GridPageFragment : Fragment(R.layout.fragment_gird_page) {
  private val binding: FragmentGirdPageBinding by viewBinding()
  ...
  private fun initData(): MutableList<GridItem> {
    ...
    values.add(
      GridItem(
        "流行创作女神你霉，泰勒斯威夫特的创作历程",
        "",
        R.drawable.grid_special_2,
        "更多为你推荐",
        3,
        GridItem.TYPE_SPECIAL
      )
    )
    values.add(
      GridItem(
