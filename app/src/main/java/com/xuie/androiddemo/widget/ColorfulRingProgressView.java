...
//        canvas.drawArc(mOval, mStartAngle, mPercent * 3.6f, false, mPaint);
        ...
        canvas.save();
        canvas.rotate(mStartAngle, getWidth() / 2, getHeight() / 2);
        canvas.drawArc(mOval, 0, mPercent * 3.6f, false, mPaint);
        canvas.restore();
    }
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mSweepGradient = new SweepGradient(0f, 0f, mFgColorStart, mFgColorEnd);
    }
